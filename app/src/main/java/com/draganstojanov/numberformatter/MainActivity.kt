...
//        Log.d("TEST", 123.5678.addLeadingZeros(6))
        ...
        Log.d("TEST", 1.showDecimals(ShowDecimals.IF_CONTAINS))
        Log.d("TEST", 2.0.showDecimals(ShowDecimals.IF_CONTAINS))
        Log.d("TEST", 3f.showDecimals(ShowDecimals.IF_CONTAINS))
        Log.d("TEST", 4.23.showDecimals(ShowDecimals.IF_CONTAINS))
        Log.d("TEST", .999.showDecimals(ShowDecimals.IF_CONTAINS))
        Log.d("TEST", 0.888.showDecimals(ShowDecimals.IF_CONTAINS))
